...
public class CadastroService implements ICadastroService {
	...
	public CadastroEntity recuperar(Long i) {
		return cadastroRepository.findById(i).get();
	}
	...
	public void excluir(Long id) {
		...
		//verificando se a empresa pode ser excluida. Resolvi  não consumir o tipo da empresa pelo parâmetro enviado pelo cliente por questões de segurança (pode ser manipulado na url)
		if(!ehFilial(id))
